...
>>>>>>> 4b76949c753de3e558e3c4a379c33895bc7bdeb0
...
\begin{figure*}[t!] 
	...
	\vspace{-1mm}
    \caption{Sensing, computation and communication equipment used for deployment \redcolor{ Mark and label appropriate things in the figure}}
...
\subfloat[\scriptsize Different resolutions of measuring electricity consumption in home: meter, circuit and appliance]{
    ...
    \subfloat[\scriptsize Different resolutions of measuring water consumption in home: inlet supply from utility, outlet supply from tank]{
        ...
        \includegraphics[scale=0.14]{./figures/water_distribution.jpg}}
        \vspace{-3mm}
    \caption{Electricity and water flow inside a home and different resolutions at which these parameters can be monitored. \redcolor{since you talk about this figure in Section 2, put it up. You should also show direct usage as well since that is the correct illustration.}}   
     ...
     \subfloat[\scriptsize Power outage by hour of day]{
          ...
          \subfloat[\scriptsize Frequency fluctuations in a week. Rated frequency is 50 Hz]{
           ...
           \subfloat[\scriptsize Voltage fluctuations in a week. Rated voltage is 230 V]{
                                       ...
                                       \includegraphics[scale=0.15]{./figures/voltage_box.png}}
                                       \hspace{1mm}
