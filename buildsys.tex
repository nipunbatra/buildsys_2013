...
We also publicly release our codebase which includes an implementation of \paradigm, scripts for collecting data from various sensors, database schemas, soft-sensors, startup scripts and the fixes we developed for common networking problems on RPi.
