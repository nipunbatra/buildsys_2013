...
\figref{fig:plug} shows the plug computer collecting ambient sensor data from ZWave controller. A manual dump of locally collected data on each Android phone was performed every 15 days.
...
\begin{figure} 
	\vspace{-5mm}    
    \centering\includegraphics[scale=0.19]{./figures/label.png}
	\vspace{-2mm}    
